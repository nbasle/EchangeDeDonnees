...
//      Check validity if an error occurs a checkException is thrown
		...
		String creditCardExpiryDate = orderDTO.getCreditCardExpiryDate();
		String creditCardNumber = orderDTO.getCreditCardNumber();
		String creditCardType = orderDTO.getCreditCardType();
